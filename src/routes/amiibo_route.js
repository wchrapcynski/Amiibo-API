...
router.get(
  "/amiibo/releaseRangeNA/:releaseStart/:releaseEnd",
  amiiboController.showReleaseRangeNA
);
...
router.get(
  "/amiibo/releaseRangeJP/:releaseStart/:releaseEnd",
  amiiboController.showReleaseRangeJP
);
// Search by name
